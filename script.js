...
function convertTxtToVcf() {
    ...
    const numberPosition = document.getElementById('number-position').value; // Ambil posisi nomor awal
        ...
        try {
            ...
            for (let i = 0; i < totalFiles; i++) {
                ...
                if (numberPosition === 'before') {
                    link.download = `${fileIndex++}_${vcfFileName}.vcf`;
                } else {
                    link.download = `${vcfFileName}_${fileIndex++}.vcf`;
                }
                ...
                console.log(`Downloaded file: ${fileIndex - 1}_${vcfFileName}.vcf`);
            }
